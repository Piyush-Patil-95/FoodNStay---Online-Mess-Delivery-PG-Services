                ...
                <tbody>
                  ...
                  $login_id= $_SESSION['login_id'];
                    ...
                    if($_SESSION['role_id']==0){
                      $querry="Select * from order_info1";
                    }
                    else
                    {
                      $querry="Select * from order_info1 where order_by='$login_id'";
                    }
            ...
            <div class="modal-body">
                <form>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="order_status" onchange="toggleReasonDiv()">
                ...
                <script>
                    function toggleReasonDiv() {
                        ...
                        var reasonDiv = document.getElementById("r_div");
